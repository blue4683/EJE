...
.result-card__summary { display: flex; justify-content: center; flex-direction: column; padding: var(--space-5); color: var(--color-primary-strong); background: var(--color-primary-weak); border-radius: var(--radius-2); }

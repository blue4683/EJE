...
<style scoped>
.card { display: grid; gap: var(--space-4); padding: var(--space-5); color: var(--color-text); text-decoration: none; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 7px; transition: background 0.18s ease; }
